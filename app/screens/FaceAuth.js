  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.appBar}>
        ...
        <Text style={styles.appBarTitle}>Face Authentication</Text>
      </View>
      <View style={styles.content}>
        <View style={styles.contentTitleView}>
          <Text style={styles.contentTitle}>Face Authentication</Text>
        </View>
        ...
        <View style={styles.faceAuthView}>
        ...
        <View style={styles.faceAuthBtnView}>
          <TouchableOpacity onPress={handleFaceAuth}>
            <View style={styles.faceAuthBtn}>
              <Text style={styles.faceAuthBtnText}>Verify</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
